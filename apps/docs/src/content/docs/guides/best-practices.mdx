...
These rules are the product contract. Details and matrices: [behavioral contracts](https://github.com/aashahin/paykernel/blob/main/packages/core/docs/behavioral-contracts.md) (in-repo), [outcomes](/guides/outcomes), [webhooks](/guides/webhooks), [adapter selection](/guides/adapter-selection), [stability](https://github.com/aashahin/paykernel/blob/main/docs/stability.md).
