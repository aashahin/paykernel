...
**Sandbox authentication and webhook configuration checked on 2026-09-11.** Authentication succeeded and the webhook ID resolved to the lab endpoint. Completed buyer checkout, delivered callbacks, and refunds are not yet recorded. See the [gateway validation matrix](/guides/gateway-validation) for scope and evidence.
:::
