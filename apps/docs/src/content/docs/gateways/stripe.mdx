...
**Test-account authentication and webhook setup checked on 2026-09-11.** The API key authenticated and a test webhook endpoint was registered. Completed buyer checkout, delivered callbacks, and refunds are not yet recorded. See the [gateway validation matrix](/guides/gateway-validation) for scope and evidence.
:::
