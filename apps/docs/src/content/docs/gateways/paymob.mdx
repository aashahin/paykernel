...
**Sandbox account payments and refunds verified on 2026-09-11.** The deployed lab completed hosted payments, a full refund, and a partial refund, then confirmed settlement through authenticated inquiry and repeated reconciliation. See the [gateway validation matrix](/guides/gateway-validation) for scope and evidence.
:::
